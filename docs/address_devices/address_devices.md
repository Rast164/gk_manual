...
{: .warning }
> Переход в аварийное состояние «Неисправно» может оставить АУ в рабочем состоянии (например, вскрытие корпуса некоторых АУ переводит их в состояние «Неисправно», но АУ при этом продолжает работать), но также может привести к потере связи с АУ (например, при физическом извлечении АУ из АЛС) и к полной неработоспособности АУ.
>
