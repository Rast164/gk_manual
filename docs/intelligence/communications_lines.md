...
PFM выполнены в топологии **кольцо**, что позволяет сохранять связь между ГК и всеми [КАУ]({% link docs/intelligence/intelligence.md %}#кау) при единичном обрыве или коротком замыкании линии. ГК автоматически определяет место неисправности ([номера]({% link docs/intelligence/addressing.md %}#адресация) ГК и КАУ, между которыми произошел обрыв или короткое замыкание линии).
{: .note-title }
> ПРИМЕЧАНИЕ
>
> ГК не определяет тип неисправности линии PFM (обрыв или короткое замыкание), в журнале событий выводится о
